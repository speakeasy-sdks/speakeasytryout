...
// Petstore - Petstore: This API stores data about available pets
...
func New(opts ...SDKOption) *Petstore {
	sdk := &Petstore{
		sdkConfiguration: sdkConfiguration{
			...
			SDKVersion:        "0.3.1",
			GenVersion:        "2.155.1",
			UserAgent:         "speakeasy-sdk/go 0.3.1 2.155.1 1.0.0 github.com/speakeasy-sdks/speakeasytryout",
		},
	}
